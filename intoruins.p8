...
72=n:bAT,hp:5,atk:3,dmg:8,armor:0,movratio:0.33,ai:,behav:wander,nightvision:,burnlight:,flying:,darkspawn:,idleanim:batidle,alert:32,hurtfx:13,profilepic:16,yoffs:0,nolightspawn:,desc1:bURNS IN LIGHT,desc2:sEES IN THE DARK,desc3:,actor:
73=n:pINK JELLY,hp:10,atk:1,dmg:2,armor:0,ai:,hurtsplit:,deathanim:jellydeath,moveanim:emove,movratio:0.33,alert:19,hurtfx:19,profilepic:16,yoffs:0,desc1:hALVES HP AND SPLITS,desc2:IN TWO WHEN HIT,desc3:,actor:
74=n:fLESH HORROR,hp:32,atk:5,dmg:8,armor:0,ai:,alert:45,hurtfx:46,movratio:0.33,profilepic:16,yoffs:0,actor:
...
76=n:mIRRORSHARD,hp:8,ai:,pdist:-2,altpdist:-4,dmg:6,armor:2,behav:wander,deathanim:sharddeath,rangep:0.3333,freezeturns:8,flying:,hurtfx:48,alert:47,idleanim:hover,ratks:blink;3_block_;-1;0;1;29|ice;6_pass_;1;0;0;28|lightning;6_pass_;1;0;0;9,profilepic:16,yoffs:0,desc1:sHOOTS LIGHTNING,desc2:sHOOTS ICE,desc3:tELEPORTS,desc4:,actor:,profilepic:16,yoffs:0,desc1:sHOOTS LIGHTNING,desc2:sHOOTS ICE,desc3:tELEPORTS,desc4:,actor:
77=n:gLOWHORN,hp:6,atk:3,dmg:4,knockback:,movandatk:,sporedeath:5,armor:1,ai:,altpdist:-2,light:3,lcool:,alert:49,hurtfx:50,deathanim:horndeath,profilepic:16,yoffs:0,desc1:aTTACKS WHILE MOVING,desc2:bURSTS INTO SPORES,desc3:,actor:
78=n:dRAGON,hp:24,atk:5,dmg:8,armor:5,nofire:,ai:,moveanim:dmove,rangep:0.33,alert:51,hurtfx:52,scrxoffset:-6.5,width:2,movratio:0.33,ratks:fire;4_pass_;1;0;0;51,profilepic:17,yoffs:0,desc1:bREATHES FIRE,desc2:dOESN'T BURN,desc3:,actor:
...
130=n:tORCH,var:item,slot:wpn,dmg:3,atk:1,lit:,throw:4,light:4,throwln:0,wpnfrms:16,idleanim:flash,desc1:cAN'T BE RE-LIT,desc2:
132=n:sPEAR,var:item,countid:wpn,slot:wpn,dmg:3,atk:1,guard:,throwatk:3,throwdmg:5,throw:6,throwln:0.25,wpnfrms:16,idleanim:flash,rndlvl:,desc1:wHILE WAITING ATTACK,desc2:CREATURES WHO MOVE,desc3:IN FRONT OF YOU,desc4:
133=n:rAPIER,var:item,countid:wpn,slot:wpn,dmg:2,atk:3,lunge:,throw:4,throwln:1,wpnfrms:16,idleanim:flash,rndlvl:,desc1:aTTACK WHEN STEPPING,desc2:TOWARDS A CREATURE,desc3:
134=n:aXE,var:item,countid:wpn,slot:wpn,dmg:3,atk:1,arc:,throw:5,throwdmg:5,wpnfrms:16,throwflp:-1,atkpat:1|3,idleanim:flash,rndlvl:
135=n:hAMMER,var:item,countid:wpn,slot:wpn,dmg:6,atk:1,stun:3,knockback:,slow:,throw:2,throwdmg:3,wpnfrms:16,idleanim:flash,rndlvl:,desc1:aTTACK TAKES 2 TURNS,desc2:
