...
74=n:fLESH HORROR,hp:30,atk:5,dmg:8,armor:0,moveanim:fleshmove,makeflesh:,ai:,flippable:,alert:45,hurtfx:46,movratio:0.33,profilepic:16,yoffs:0,yfacespr:1,desc1:cREATES FLESH MOUNDS,desc2:WHEN ATTACKING OR,desc3:MOVING,desc4:,actor:
89=n:fLESH MOUND,hp:3,nopush:,death:42,hurtfx:10,flippable:,idleanim:fleshidle,yoffs:0,deathanim:fleshsplode,isflesh:
