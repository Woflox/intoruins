...
132=n:sPEAR,var:item,slot:wpn,dmg:3,atk:1,guard:,throwatk:3,throwdmg:5,throw:6,throwln:0.25,wpnfrms:16,idleanim:flash,rndlvl:,desc1:wHILE WAITING ATTACK,desc2:CREATURES WHO MOVE,desc3:IN FRONT OF YOU,desc4:
...
134=n:aXE,var:item,slot:wpn,dmg:3,atk:1,arc:,throw:5,throwdmg:5,wpnfrms:16,throwflp:-1,atkpat:1|3,idleanim:flash,rndlvl:
135=n:hAMMER,var:item,slot:wpn,dmg:6,atk:1,stun:3,knockback:,slow:,throw:2,throwdmg:3,wpnfrms:16,idleanim:flash,rndlvl:,desc1:aTTACK TAKES 2 TURNS,desc2:
...
300=,nid:oRB OF lIFE,orb:life,orbfx:17,desc1:hEALS YOU FULLY,desc2:,desc3:+3 TO MAX HP,desc4:
...
302=,nid:oRB OF pOWER,orb:eMPOWER,orbfx:55,desc1:pERMANENTLY EMPOWERS,desc2:AN ITEM,desc3:
303=,nid:oRB OF dATA,orb:iDENTIFY,orbfx:18,desc1:iDENTIFY AN ITEM,desc2:,desc3:tHROW TO IDENTIFY,desc4:A CREATURE,desc5:
304=,nid:oRB OF lIGHT,orb:light,orbfx:53,desc1:pROVIDES LIGHT FOR,desc2:A WHILE,desc3:,desc4:tHROW FOR A BRIGHT,desc5:FLASH,desc6:
...
317=,nid:sTAFF OF lYTNING,dmg:4,charges:3,maxcharges:3,range:3,linemode:pass,rangetyp:lightning,usefx:9,desc1:zAPS MULTIPLE,desc2:TARGETS IN A LINE,desc3:
318=,nid:sTAFF OF iCE,charges:3,maxcharges:3,range:3,linemode:pass,freezeturns:7,rangetyp:ice,usefx:28,desc1:fREEZES MULTIPLE,desc2:TARGETS IN A LINE,desc3:,desc4:(dAMAGE REDUCES,desc5: FREEZE DURATION)
