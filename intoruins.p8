...
71=n:jACKAL,hp:4,atk:0,dmg:2,armor:0,ai:,flippable:,altpdist:-2,movandatk:,alert:20,hurtfx:21,profilepic:16,yoffs:0,yfacespr:1,desc1:aTTACKS WHILE MOVING,desc2:,canfall:,actor:
65=n:gOBLIN,hp:7,atk:1,dmg:3,armor:0,ai:,flippable:,alert:30,hurtfx:11,profilepic:16,yoffs:0,yfacespr:1,canfall:,actor:
66=n:gOBLIN MYSTIC,hp:6,armor:0,ai:,flippable:,pdist:-2,alert:30,hurtfx:11,ratks:summon;1_block;0;0;0;22;|heal;1;0;1;0;17,rangep:1,profilepic:16,yoffs:0,yfacespr:1,desc1:sUMMONS SPIRITS,desc2:hEALS ALLIES,desc3:,canfall:,actor:,healer:
...
68=n:gOBLIN WARLOCK,hp:6,dmg:4,armor:0,ai:,flippable:,pdist:-3,movratio:-0.25,alert:30,hurtfx:11,ratks:fire;4__;1;0;0;36,rangep:0.25,profilepic:16,yoffs:0,yfacespr:1,desc1:sHOOTS FIRE,desc2:,canfall:,actor:
69=n:oGRE,hp:15,atk:3,dmg:8,armor:1,slow:,knockback:,stun:2,ai:,flippable:,alert:31,hurtfx:16,profilepic:16,yoffs:0,yfacespr:1,desc1:aTTACK TAKES 2 TURNS,desc2:,canfall:,actor:
...
73=n:pINK JELLY,hp:10,atk:1,dmg:2,armor:0,ai:,flippable:,hurtsplit:,deathanim:jellydeath,moveanim:emove,movratio:0.33,alert:19,hurtfx:19,profilepic:16,yoffs:0,desc1:hALVES HP AND SPLITS,desc2:IN TWO WHEN HIT,desc3:,canfall:,actor:
74=n:fLESH HORROR,hp:30,atk:5,dmg:8,armor:0,moveanim:fleshmove,makeflesh:,ai:,flippable:,alert:45,hurtfx:46,movratio:0.33,profilepic:16,yoffs:0,yfacespr:1,desc1:lEAVES FLESH TRAIL.,desc2:sURROUNDS YOU WITH,desc3:FLESH WHEN ATTACKING,desc4:,canfall:,actor:
...
77=n:gLOWHORN,hp:6,atk:3,dmg:4,knockback:,movandatk:,sporedeath:5,armor:0,ai:,flippable:,altpdist:-2,light:3,lcool:,alert:49,hurtfx:50,deathanim:horndeath,profilepic:16,yoffs:0,yfacespr:1,desc1:aTTACKS WHILE MOVING,desc2:bURSTS INTO SPORES,desc3:,canfall:,actor:
78=n:dRAGON,hp:20,atk:5,dmg:8,armor:5,nofire:,ai:,flippable:,moveanim:dmove,rangep:0.33,alert:51,hurtfx:52,scrxoffset:-6.5,width:2,movratio:0.33,ratks:fire;4_pass_;1;0;0;51,profilepic:17,yoffs:0,yfacespr:1,desc1:bREATHES FIRE,desc2:dOESN'T BURN,desc3:,canfall:,actor:
137=n:mUSHROOM,hp:1,sporedeath:12,light:4,lcool:,deathanim:mushdeath,flippable:,flammable:,death:42,nopush:,yoffs:1,desc1:bURSTS INTO HEALING,desc2:SPORES,desc3:,canfall:
136=n:bRAZIER,hp:1,nofire:,hitpush:,pushanim:brazierpush,fallanim:brazierfall,hitfire:,light:4,idleanim:brazieridle,deathanim:brazierdeath,death:23,yoffs:0,desc1:eASILY KNOCKED OVER,desc2:,canfall:
...
130=n:tORCH,var:item,slot:wpn,torch:,dmg:3,atk:1,lit:,throw:4,light:4,throwln:0,wpnfrms:16,idleanim:flash,desc1:rE-LIGHT ON BRAZIERS,desc2:,canfall:
132=n:sPEAR,var:item,countid:wpn,slot:wpn,dmg:3,atk:1,guard:,throwatk:3,throwdmg:5,throw:6,throwln:0.25,wpnfrms:16,idleanim:flash,rndlvl:,desc1:wHILE WAITING ATTACK,desc2:CREATURES WHO MOVE,desc3:IN FRONT OF YOU,desc4:,canfall:
133=n:rAPIER,var:item,countid:wpn,slot:wpn,dmg:2,atk:3,lunge:,throw:4,throwln:1,wpnfrms:16,idleanim:flash,rndlvl:,desc1:aTTACK WHEN STEPPING,desc2:TOWARDS A CREATURE,desc3:,canfall:
...
135=n:hAMMER,var:item,countid:wpn,slot:wpn,dmg:6,atk:1,stun:3,knockback:,slow:,throw:2,throwdmg:3,wpnfrms:16,idleanim:flash,rndlvl:,desc1:aTTACK TAKES 2 TURNS,desc2:,canfall:
...
316=,nid:sTAFF OF fIRE,countid:wpn,dmg:4,charges:3,maxcharges:3,range:3,rangetyp:fire,usefx:36,desc1:cREATES A LINE OF,desc2:FIRE AND DAMAGES,desc3:TARGET,desc4:
317=,nid:sTAFF OF lYTNING,countid:wpn,dmg:4,charges:3,maxcharges:3,range:3,linemode:pass,rangetyp:lightning,usefx:9,desc1:zAPS MULTIPLE,desc2:TARGETS IN A LINE,desc3:
318=,nid:sTAFF OF iCE,countid:wpn,charges:3,maxcharges:3,range:3,linemode:pass,freezeturns:7,rangetyp:ice,usefx:28,desc1:fREEZES MULTIPLE,desc2:TARGETS IN A LINE,desc3:,desc4:(dAMAGE REDUCES,desc5: FREEZE DURATION)
319=,nid:sTAFF OF bLINK,countid:wpn,charges:3,maxcharges:3,range:3,linemode:block,rangetyp:blink,usefx:29,desc1:tELEPORT TO TARGET,desc2:SPACE,desc3:
58=37
38=10
54=10
44=38
