...
76=n:mIRRORSHARD,hp:8,ai:,pdist:-2,altpdist:-4,dmg:6,armor:1,behav:wander,deathanim:sharddeath,rangep:0.3333,freezeturns:8,flying:,hurtfx:48,alert:47,idleanim:hover,ratks:blink;3_block_;-1;0;1;29|ice;6_pass_;1;0;0;28|lightning;6_pass_;1;0;0;9,profilepic:16,yoffs:0,desc1:sHOOTS LIGHTNING,desc2:sHOOTS ICE,desc3:tELEPORTS,desc4:,actor:,profilepic:16,yoffs:0,desc1:sHOOTS LIGHTNING,desc2:sHOOTS ICE,desc3:tELEPORTS,desc4:,actor:
