...
if navigable()and
pdist<mindist and pdist>-1000and not item and(allowent or not ent)then return not _typ or create(_typ,pos)end end function postproc()function ca(permissive)for i=1,20do calcdist("pdist",gentl)local unreach,numtls,bestdist={},0,100alltiles(function(_ENV)
if navigable()and
